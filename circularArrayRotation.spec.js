...
import circularArrayRotation from "./circularArrayRotation.js"
...
describe("Circular Array Rotation Function Test", () => {
    ...
    describe("Negative Special Cases", () => {
        it("F006 - Empty array (a), non-empty query, and positive k", async () => {
            try{
                var result = await circularArrayRotation([], 2, [1,2])
            } catch (err) {
                var result = err
            }
        ...
        it("F008 - Non-empty query but the element value is greater than length of array a", async () => {
            try{
                var result = await circularArrayRotation([1,2,3], 2, [4])
            } catch (err) {
                var result = err
            }
            expect(result).to.equal("query must be less than length of a")
        ...
        it("F009 - a and query is not array", async () => {
            try{
                var result = await circularArrayRotation("[1,2,3]", 2, 9)
            } catch (err) {
                var result = err
            }
        ...
        it("F010 - k is not number", async () => {
            try{
                var result = await circularArrayRotation([1,2,3], "string", [1,2])
            } catch (err) {
                var result = err
            }
            expect(result).to.equal("input type is not suitable")
        ...
        it("F011 - k is not integer", async () => {
            try{
                var result = await circularArrayRotation([1,2,3], 2.5, [1,2])
            } catch (err) {
                var result = err
            }
